...
// get_addition_deletion_multiaxis(repo:json, user:string, token:string) -> Display multiaxis Graph
async function get_addition_deletion_multiaxis(repos, user, token) {
    let label = [];
    let commits = [];
    let addition = [];
    let deletion = [];
